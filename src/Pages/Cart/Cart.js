    ...
    <Helmet title="Cart">
      ...
      <section className="cart my-5">
        <div className="container">
          {cartItem.length === 0 ? (
            <div> 
              <h2 className="text-center mx-5 fs-3">No Item in Cart!</h2>
            </div> 
          ) : null}
          <div className="row">
                ...
                {cartItem.length === 0 ? (
                  ...
                  <table className="table bordered">
                    ...
                    <tbody>
                     ...
                     <button type="button" className="btn btn-danger" onClick={removeAllItem}>Remove all Item</button>
                     </div>
                    </tbody>
                  </table>
                )}
            ...
            <div className="col-lg-3">
              ...
              <div className="shopping_btn my-3">
                <Link to="/shop"><Button title="Continue Shopping" /></Link>
              </div>
              <div className="shopping_btn my-3">
              <Link to="/checkout"> <Button title="Checkout" /></Link>
              </div>
            </div>
          </div>
          </div>
